        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <div className="text-center animate-fade-up" style={{ animationDelay: '0.1s' }}>
              <div className="mx-auto w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center mb-4 text-white text-2xl font-bold">
                1
              </div>
              <h3 className="text-lg font-semibold text-primary mb-2">Apply Online</h3>
              <p className="text-muted-foreground">Fill out our simple application form</p>
            </div>
            <div className="text-center animate-fade-up" style={{ animationDelay: '0.2s' }}>
              <div className="mx-auto w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center mb-4 text-white text-2xl font-bold">
                2
              </div>
              <h3 className="text-lg font-semibold text-primary mb-2">Quick Review</h3>
            ...
            <div className="text-center animate-fade-up" style={{ animationDelay: '0.3s' }}>
              ...
              <h3 className="text-lg font-semibold text-primary mb-2">Get Funded</h3>
              <p className="text-muted-foreground">Receive funds in as little as 24 hours</p>
            </div>
          </div>

          <Card className="bg-gradient-card shadow-elegant border-0 animate-scale-in">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-primary">Quick Application Form</CardTitle>
              <CardDescription>
                Takes less than 5 minutes to complete • No impact on credit score
              </CardDescription>
            </CardHeader>
            <CardContent>
